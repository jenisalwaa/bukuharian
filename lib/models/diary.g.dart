...
extension DiaryQueryFilter on QueryBuilder<Diary, Diary, QFilterCondition> {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> textEqualTo(
    String value, {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> textGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> textLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> textBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> textStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> textEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> textContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> textMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> textIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'text',
        value: '',
  ...
  QueryBuilder<Diary, Diary, QAfterFilterCondition> textIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'text',
        value: '',
...
extension DiaryQuerySortBy on QueryBuilder<Diary, Diary, QSortBy> {
  ...
  QueryBuilder<Diary, Diary, QAfterSortBy> sortByTextDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DiaryQuerySortThenBy on QueryBuilder<Diary, Diary, QSortThenBy> {
  ...
  QueryBuilder<Diary, Diary, QAfterSortBy> thenByText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.asc);
    });
  }

  QueryBuilder<Diary, Diary, QAfterSortBy> thenByTextDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.desc);
    });
  }
...
extension DiaryQueryProperty on QueryBuilder<Diary, Diary, QQueryProperty> {
  ...
  QueryBuilder<Diary, String, QQueryOperations> textProperty() {
    return QueryBuilder.apply(this, (query) {
